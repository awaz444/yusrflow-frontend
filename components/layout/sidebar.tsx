...
export function Sidebar({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "border-b border-border flex items-center h-20 transition-all duration-300 shrink-0",
          !isExpanded ? "p-0 justify-center" : "px-6 justify-between",
        )}
      >
        <Link
          href="/dashboard"
            ...
            <Link
              ...
              className={cn(
                ...
                !isExpanded
                  ...
                  : "w-full justify-start px-4 py-3 gap-3",
              )}
      ...
      <div className="p-4 border-t border-border space-y-4 shrink-0 overflow-visible">
        <div
          className={cn(
